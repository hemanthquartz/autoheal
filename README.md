...
| eval raw_label_regressor = future_5m_502_count + future_10m_502_count
| eval label_regressor = if(raw_label_regressor > 15, 15, raw_label_regressor)  /* optional: cap extreme bursts */
...
| fields _time serverResponseLatency_lag1 serverResponseLatency_lag2 serverResponseLatency_lag3 
    ...
    latency_to_sent_ratio received_to_sent_ratio latency_change label_regressor
